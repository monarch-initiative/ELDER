...
class HPOClustering:
    def __init__(self):
        ...
        self.all_children = self.get_all_children(self.graph, root_node=self.phenotypic_abnormality_id)
    ...
    def get_all_children(self, graph, root_node):
        # nx.descendants returns all nodes that can be reached from root_node in a directed graph.
        return list(nx.descendants(graph, root_node))
