...
class DiseaseDataAnalyzer:
    def __init__(self, tsv_file_path: str):
        ...
        self._disease_to_hps_from_omim = OMIMHPOExtractor.extract_omim_hpo_mappings_with_frequencies_1(data)
    ...
    def _load_data_numeric(self):
        ...
        df['Exom  iserScore'] = pd.to_numeric(df['ExomiserScore'], errors='coerce')
    ...
    def map_disease_to_hp_terms(self, omim_hpo_extractor: OMIMHPOExtractor) -> Dict[str, List[str]]:
        ...
        return omim_hpo_extractor.extract_omim_hpo_mappings_with_frequencies_1(data)
